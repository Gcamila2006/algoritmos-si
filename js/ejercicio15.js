...
nombre5 = prompt("Ingrese nombre del empleado 5");
    ...
    a = parseFloat(prompt("Ingrese coeficiente a"));
    b = parseFloat(prompt("Ingrese coeficiente b"));
    c = parseFloat(prompt("Ingrese coeficiente c"));
    ...
    if (discriminante > 0) {
      ...
      console.log("Raíces reales y distintas:");
      console.log("Raíz 1: " + raiz1);
      console.log("Raíz 2: " + raiz2);
    } else if (discriminante === 0) {

      raiz = -b / (2*a);
      console.log("Raíz real y doble:");
      console.log("Raíz: " + raiz);
    } else {

      parteReal = -b / (2*a);
      parteImaginaria = Math.sqrt(-discriminante) / (2*a);
      console.log("Raíces complejas:");
      console.log("Raíz 1: " + parteReal + " + " + parteImaginaria + "i");
      console.log("Raíz 2: " + parteReal + " - " + parteImaginaria + "i");
    }
